generate_s_net_R <- function(network_type,
  ...
  if (network_type == "MSM") {
    if (init_net == TRUE) {
      ...
      factor_3_assort = simObj$trans_params$Assortativity_MSM %>% filter(`Age Category` == "Geography") %>% pull(Value)

      deg_seq_net = deg_seq_net %>%
        mutate(block = case_when((risk == "MSM" & hiv_status == "0" & race == "black") ~ 1,
                                 (risk == "MSM" & hiv_status == "1" & race == "black") ~ 2,
                                 (risk == "MSMandIDU" & hiv_status == "0" & race == "black") ~ 3,
                                 (risk == "MSMandIDU" & hiv_status == "1" & race == "black") ~ 4,
                                 (risk == "MSM" & hiv_status == "0" & race == "hispanic") ~ 5,
                                 (risk == "MSM" & hiv_status == "1" & race == "hispanic") ~ 6,
                                 (risk == "MSMandIDU" & hiv_status == "0" & race == "hispanic") ~ 7,
                                 (risk == "MSMandIDU" & hiv_status == "1" & race == "hispanic") ~ 8,
                                 (risk == "MSM" & hiv_status == "0" & race == "other") ~ 9,
                                 (risk == "MSM" & hiv_status == "1" & race == "other") ~ 10,
                                 (risk == "MSMandIDU" & hiv_status == "0" & race == "other") ~ 11,
                                 (risk == "MSMandIDU" & hiv_status == "1" & race == "other") ~ 12)) %>%
        arrange(block)
    } else {
    ...
    if (init_net == TRUE) {
      ...
      factor_3_assort = simObj$trans_params$Assortativity_nonMSM %>% filter(`Age Category` == "Geography") %>% pull(Value)

      deg_seq_net = deg_seq_net %>%
        mutate(block = case_when((gender == "female" & risk == "other" & hiv_status == "0" & race == "black") ~ 1,
                                 (gender == "female" & risk == "other" & hiv_status == "1" & race == "black") ~ 2,
                                 (gender == "female" & risk == "IDU" & hiv_status == "0" & race == "black") ~ 3,
                                 (gender == "female" & risk == "IDU" & hiv_status == "1" & race == "black") ~ 4,
                                 (gender == "male" & risk == "other" & hiv_status == "0" & race == "black") ~ 13,
                                 (gender == "male" & risk == "other" & hiv_status == "1" & race == "black") ~ 14,
                                 (gender == "male" & risk == "IDU" & hiv_status == "0" & race == "black") ~ 15,
                                 (gender == "male" & risk == "IDU" & hiv_status == "1" & race == "black") ~ 16,
                                 (gender == "female" & risk == "other" & hiv_status == "0" & race == "hispanic") ~ 5,
                                 (gender == "female" & risk == "other" & hiv_status == "1" & race == "hispanic") ~ 6,
                                 (gender == "female" & risk == "IDU" & hiv_status == "0" & race == "hispanic") ~ 7,
                                 (gender == "female" & risk == "IDU" & hiv_status == "1" & race == "hispanic") ~ 8,
                                 (gender == "male" & risk == "other" & hiv_status == "0" & race == "hispanic") ~ 17,
                                 (gender == "male" & risk == "other" & hiv_status == "1" & race == "hispanic") ~ 18,
                                 (gender == "male" & risk == "IDU" & hiv_status == "0" & race == "hispanic") ~ 19,
                                 (gender == "male" & risk == "IDU" & hiv_status == "1" & race == "hispanic") ~ 20,
                                 (gender == "female" & risk == "other" & hiv_status == "0" & race == "other") ~ 9,
                                 (gender == "female" & risk == "other" & hiv_status == "1" & race == "other") ~ 10,
                                 (gender == "female" & risk == "IDU" & hiv_status == "0" & race == "other") ~ 11,
                                 (gender == "female" & risk == "IDU" & hiv_status == "1" & race == "other") ~ 12,
                                 (gender == "male" & risk == "other" & hiv_status == "0" & race == "other") ~ 21,
                                 (gender == "male" & risk == "other" & hiv_status == "1" & race == "other") ~ 22,
                                 (gender == "male" & risk == "IDU" & hiv_status == "0" & race == "other") ~ 23,
                                 (gender == "male" & risk == "IDU" & hiv_status == "1" & race == "other") ~ 24
        )) %>%
        arrange(block)
    } else {
    ...
    if (init_net == TRUE) {
      ...
      deg_seq_net = deg_seq_net %>%
        mutate(block = case_when((gender == "female" & risk == "other" & hiv_status == "0" & race == "black") ~ 1,
                                 ...
                                 (gender == "female" & risk == "IDU" & hiv_status == "0" & race == "black") ~ 3,
                                 (gender == "female" & risk == "IDU" & hiv_status == "1" & race == "black") ~ 4,
                                 (gender == "male" & risk == "MSM" & hiv_status == "0" & race == "black") ~ 13,
                                 (gender == "male" & risk == "MSM" & hiv_status == "1" & race == "black") ~ 14,
                                 (gender == "male" & risk == "MSMandIDU" & hiv_status == "0" & race == "black") ~ 15,
                                 (gender == "male" & risk == "MSMandIDU" & hiv_status == "1" & race == "black") ~ 16,
                                 (gender == "female" & risk == "other" & hiv_status == "0" & race == "hispanic") ~ 5,
                                 (gender == "female" & risk == "other" & hiv_status == "1" & race == "hispanic") ~ 6,
                                 (gender == "female" & risk == "IDU" & hiv_status == "0" & race == "hispanic") ~ 7,
                                 (gender == "female" & risk == "IDU" & hiv_status == "1" & race == "hispanic") ~ 8,
                                 (gender == "male" & risk == "MSM" & hiv_status == "0" & race == "hispanic") ~ 17,
                                 (gender == "male" & risk == "MSM" & hiv_status == "1" & race == "hispanic") ~ 18,
                                 (gender == "male" & risk == "MSMandIDU" & hiv_status == "0" & race == "hispanic") ~ 19,
                                 (gender == "male" & risk == "MSMandIDU" & hiv_status == "1" & race == "hispanic") ~ 20,
                                 (gender == "female" & risk == "other" & hiv_status == "0" & race == "other") ~ 9,
                                 (gender == "female" & risk == "other" & hiv_status == "1" & race == "other") ~ 10,
                                 (gender == "female" & risk == "IDU" & hiv_status == "0" & race == "other") ~ 11,
                                 (gender == "female" & risk == "IDU" & hiv_status == "1" & race == "other") ~ 12,
                                 (gender == "male" & risk == "MSM" & hiv_status == "0" & race == "other") ~ 21,
                                 (gender == "male" & risk == "MSM" & hiv_status == "1" & race == "other") ~ 22,
                                 (gender == "male" & risk == "MSMandIDU" & hiv_status == "0" & race == "other") ~ 23,
                                 (gender == "male" & risk == "MSMandIDU" & hiv_status == "1" & race == "other") ~ 24
        )) %>%
        arrange(block)
    } else {
...
generate_dcsbm_b_matrix <- function(network_type,
  ...
  if (network_type %in% c("MSM", "HET", "MSMW")) {
    if (TRUE) {
      ...
      dcsbm_B_1 = suppressMessages(bind_cols(dcsbm_B_race, suppressMessages(bind_cols(dcsbm_B_norace, dcsbm_B_norace))))
      dcsbm_B_2 = suppressMessages(bind_cols(dcsbm_B_norace, suppressMessages(bind_cols(dcsbm_B_race, dcsbm_B_norace))))
      dcsbm_B_3 = suppressMessages(bind_cols(dcsbm_B_norace, suppressMessages(bind_cols(dcsbm_B_norace, dcsbm_B_race))))
      dcsbm_B = suppressMessages(bind_rows(dcsbm_B_1, suppressMessages(bind_rows(dcsbm_B_2, dcsbm_B_3))))
